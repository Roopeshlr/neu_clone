        ...
        children: [
          Column(
            ...
            children: [
              ...
              if(widgetProperty.first.subtitle != null)const SizedBox(height: 8.0,),
              if(widgetProperty.first.subtitle != null)Text(widgetProperty.first.subtitle!,
                style: const TextStyle(fontSize: 12,fontWeight: FontWeight.bold,color: Colors.white),),
            ],

          ),
          if(widgetProperty.first.imageUrl != null)Image.network(widgetProperty.first.imageUrl!)
        ],
      ),
    );
  }

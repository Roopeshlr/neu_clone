...
class NeuBannerWidget extends StatelessWidget {
  ...
  const NeuBannerWidget(this.widgetProperty ,{Key? key,this.onTapCallback}) : super(key: key);
      ...
      child: GestureDetector(
        onTap: () {
          if (onTapCallback != null) {
            onTapCallback!(widgetProperty.first.ctaType!, widgetProperty.first.ctaPath!);
          }
        },
        child: ClipRRect(
